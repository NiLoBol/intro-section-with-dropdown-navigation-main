                    ...
                    <div class="offcanvas offcanvas-end bg-light" tabindex="-1" id="offcanvasDarkNavbar"
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="navbar-nav mx-3 mt-2 mt-lg-0">
                                ...
                                <a name="Register" id="Register" class="btn btnre" href="#" role="button">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        content.innerHTML =
            `
                    ...
                    <div class="col-12 text-center mx-3">
                        <p class="head-font">Make <br id="make">remote work</p>
                        <p class="p-get">Get your team in sync, no matter your location. Streamline processes,
